...
from simcore.sampler.sequences import default_sample_count, random_units, units_to_params
    ...
    def __init__(
        ...
        **_: Any,
        ...
        self._samples = [
            ...
            for units in random_units(self._n_samples, len(parameter_space.parameters), seed)
        ]
        self._index = 0
